...
const MedicalTable = ({
  ...
  const [date, setDate] = useState({
    year: measurement.date.split("T")[0].split("-")[0],
    month: measurement.date.split("T")[0].split("-")[1],
    day: measurement.date.split("T")[0].split("-")[2],
    hours: measurement.date.split("T")[1].split(":")[0],
    mins: measurement.date.split("T")[1].split(":")[1],
  });
  ...
  const setInternationalizedValues = () => {
    ...
    if (i18n.language === "en") {
      ...
      newData.hdlCholesterolMin = (newData.hdlCholesterolMin * 38.67).toFixed(
        2
      );
      newData.hdlCholesterolMax = (newData.hdlCholesterolMax * 38.67).toFixed(
        2
      );
      newData.vldlCholesterolMin = (newData.vldlCholesterolMin * 38.67).toFixed(
        2
      );
      newData.vldlCholesterolMax = (newData.vldlCholesterolMax * 38.67).toFixed(
        2
      );
      newData.ldlCholesterolMin = (newData.ldlCholesterolMin * 38.67).toFixed(
        2
      );
      newData.ldlCholesterolMax = (newData.ldlCholesterolMax * 38.67).toFixed(
        2
      );
